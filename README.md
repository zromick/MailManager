# Mail Manager for Stable

Problem: Stable's clients need to be reminded to update information that may have caused issues with getting mail sent out to them.
